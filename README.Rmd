...
[![Codecov (main)](https://codecov.io/gh/mhdzy/kpthor/branch/main/graph/badge.svg)](https://codecov.io/gh/mhdzy/kpthor?branch=main)
[![Codecov (dev)](https://codecov.io/gh/matthewhandzy/kp/branch/dev/graph/badge.svg)](https://codecov.io/gh/mhdzy/kpthor?branch=dev)
<!-- badges: end -->

The goal of **kpthor** is to create an interactive site that lets you track your dog's
activity over time.
