...
### KPthorSQL
The DSN name used for production is `KPthorSQL`, but supports a `development` mode which uses the `KPthorSQL-dev` DSN name. Add the following entry to `/etc/odbc.ini`, and fill in your specific connection details:
